READABLE_PATH_NAME_CORRECTIONS = {
   ...
   # Plants
   "BP_BerryBush_C": "Paleberry",
   "BP_NutBush_C": "Beryl Nut",
   "BP_Shroom_01_C": "Bacon Agaric",
   "BP_SporeFlower_C": "Spore Flower",
   "BP_VolumeGas_01_C": "Gas Pillar",

   # Creatures
   "Desc_HogAlpha_C": "Alpha Hog",                                              "Char_AlphaHog_C": "Alpha Hog",
   ...
   "Desc_SpitterAquatic_Small_C": "Small Aquatic Spitter",                      "Char_SpitterAquaticSmall_C": "Small Aquatic Spitter",
   "Desc_SpitterDesert_Alpha_C": "Alpha Desert Spitter",                        "Char_SpitterDesertAlpha_C": "Alpha Desert Spitter",
   "Desc_SpitterDesert_Small_C": "Small Desert Spitter",                        "Char_SpitterDesertSmall_C": "Small Desert Spitter",
   "Desc_SpitterForest_Alpha_C": "Alpha Forest Spitter",                        "Char_SpitterForestAlpha_C": "Alpha Forest Spitter",
   "Desc_SpitterForest_Small_C": "Small Forest Spitter",                        "Char_SpitterForestSmall_C": "Small Forest Spitter",
   "Desc_SpitterForest_Red_Alpha_C": "Alpha Red Forest Spitter",                "Char_SpitterForestRedAlpha_C": "Alpha Red Forest Spitter",
   "Desc_SpitterForest_Small_Red_C": "Small Red Forest Spitter",                "Char_SpitterForestRedSmall_C": "Small Red Forest Spitter",
   "Desc_StingerAlpha_C": "Alpha Stinger",                                      "Char_Stinger_C": "Stinger",
   "Desc_StingerElite_C": "Gas Stinger",                                        "Char_EliteStinger_C": "Gas Stinger",
   "Desc_StingerSmall_C": "Small Stinger",                                      "Char_Stinger_Child_C": "Small Stinger",
   "Char_BigCrabHatcher_C": "Elite Flying Crab Hatcher",
   "Char_CrabHatcher_C": "Flying Crab Hatcher",
   ...
   "Build_LargeFan_C": "Large Fan",
   "Build_LargeVent_C": "Large Vent",
   ...
   "Desc_ComputerQuantum_C": "Quantum Computer",
   ...
   "Desc_GasTank_C": "Empty Fluid Tank", # (Tank for fluid and gas)
   ...
   "Recipe_Alternate_Turbofuel_C": "Turbofuel", # Why is this called "Alternate"?  Is this name accurate?
