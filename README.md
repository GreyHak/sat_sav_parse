...
and manipulating the contents.  Supports Satisfactory releases v1.2.0.0, v1.2.1.0, v1.2.2.0 and v1.2.2.1.
...
Usage:
  ...
  - `py sav_cli.py --set-session-name <new-session-name> <original-save-filename> <new-save-filename> [--same-time]`
  ...
  - `py sav_cli.py --import-node-types <original-save-filename> <input-json-filename> <new-save-filename> [--same-time]`
  ...
  - `py sav_cli.py --dismantle-crash-site <drop-pod-name> <original-save-filename> <new-save-filename> [--same-time]`
  - `py sav_cli.py --list-map-markers <save-filename>`
  - `py sav_cli.py --export-map-markers <save-filename> <output-json-filename>`
  - `py sav_cli.py --remove-marker <marker-guid> <original-save-filename> <new-save-filename> [--same-time]`
  ...
  - `py sav_cli.py --list-water-extractors <save-filename>`
...
Command line: `py sav_to_html.py <save-filename> [output-html-directory]`
